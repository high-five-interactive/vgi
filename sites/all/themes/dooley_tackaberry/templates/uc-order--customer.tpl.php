          ...
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              ...
              <tr>
                ...
                <td width="98%">
                  <?php print $order->delivery_first_name.' '.$order->delivery_last_name; ?>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
              ...
              <tr>
                <td colspan="2">
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    <tr>
                      <?php if ($order->payment_method != 'purchase_order') : ?>
              ...
              <tr>
                <td nowrap="nowrap">
                  ...
                  <?php else: ?>
                  <b><?php print t('Order Total:'); ?></b><br />*Shipping charges and taxes may be applied
                  <?php endif; ?>
                </td>
              ...
              <tr>
                <td nowrap="nowrap">
                  <b><?php print t('Purchase Order Number:'); ?></b>
                </td>
                <td width="98%">
                  <?php print $order->payment_details['po_number']; ?>
                </td>
              </tr>
              <?php endif; ?>
                ...
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      ...
                      <td width="98%">
                        <?php print date('m/d/Y - g:ma',$order->created); ?>
                      </td>
                    </tr>
                      ...
                      <td colspan="2">
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <?php 
                            ...
                            $uom = field_get_items('node',$p,'field_unit_measurement');

                            $uom = (!empty($uom)) ? reset(reset($uom)) : 'Item';
                          ?>
                          <tr>
                            <td valign="top" nowrap="nowrap">
                              <b><?php print $product->qty; ?> <?php echo $uom; ?>&nbsp;-&nbsp;</b>
                            </td>
                            <td width="98%">
                              <b><?php print $product->title; ?> - <?php print $product->total_price; ?></b>
                              <?php print $product->individual_price; ?><br />
                              <?php print t('PN'); ?>: <?php print $product->model; ?><br />
                    ...
                    <tr>
                      <td nowrap="nowrap" colspan="2">
                        <b><?php print t('Order Comments: '); ?></b>
                      </td>
                    </tr>
                    <tr>
                      <td width="100%" colspan="2">
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          <tr>
                            <th valign="top" nowrap="nowrap">Date</th>
                            <th valign="top" nowrap="nowrap">Status</th>
                            <th width="90%">Message</th>
                          </tr>
                          <?php foreach ($comments as $c): ?>
                          <?php 
                            $date = format_date($c->created,'custom','m/d/Y');
                            $uid = $c->uid;
